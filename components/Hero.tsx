  ...
  return (
    <div className="app relative w-full min-h-screen overflow-hidden font-display">
      ...
      <div className="page-container relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 sm:px-6 md:px-10">
        ...
        >
          {/* Animated GIF */}
          <div className="hidden absolute -top-10 right-6 w-20 h-20 sm:w-24 sm:h-24 object-contain animate-bounce-slow">
            <Image
          ...
          <div className="text-center space-y-6 relative">
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl font-black text-[#1b0d14] leading-snug"
            ...
            >
              <p>
                Hoy es un día muy especial para nosotros.... no hacemos nada más y nada menos que 6 MESECITOS!! OLEEE.
                Abre esta carta que tengo algo especial para tí preparado....
              </p>
              <p className="pt-3 hidden">
                <span className="font-semibold text-[#f04299]">
                  Click below to see what it is! ✨
                </span>
                <span className="hidden inline-block w-1.5 h-4 bg-[#f04299]/70 ml-1 animate-cursor"></span>
              </p>
            </motion.div>
        ...
        <div className="mt-8 text-xs text-[#9a4c73] text-center hidden">
