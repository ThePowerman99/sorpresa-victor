        ...
        <div className="relative z-10 w-full max-w-2xl transition-all duration-600 opacity-100 translate-y-0">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-[#f04299] mb-2">
              Espero que te haya gustado todo mi amor
            </h2>
            <p className="text-sm sm:text-base text-[#9a4c73] mb-5">
              Amo cada cachito de tu ser
            </p>

            {/* Animated Hearts */}
            <div className="hidden flex justify-center gap-2 mb-5">
            ...
            <div className="text-lg sm:text-xl font-semibold text-[#1b0d14] mb-1">
              <span className="text-[#c0396f]">¡¡TE AMO!!</span>
            </div>

            {/* Date */}
            <div className="text-xl text-[#9a4c73] mb-6">08/03/2026</div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 relative">
              ...
              <button
                ...
                className="hidden rounded-full bg-[#9be7c4] px-5 py-2.5 text-sm sm:text-base font-medium shadow hover:brightness-95 transition cursor-pointer"
              >
                Send a Virtual Kiss 💋
              </button>
            </div>
