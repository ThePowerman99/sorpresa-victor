...
const tracks: Track[] = [
  {
    id: 1,
    title: 'Primera cita',
    description: 'Nuestra primera cita con nuestra primera canción',
    image: '/assets/music1.jpg',
    audio: '/assets/music1-Bpgt1BZ5.mp3',
  },
  {
    id: 2,
    title: 'La portada de la feria',
    description: "Eres mi antidepresivo",
  ...
  },
  {
    ...
    description: 'Como no la canto te dejo tu favorita por aqui mi amor... jajajaja',
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className="text-center">
            <h2 className="text-[#f04299] text-lg font-bold leading-tight">
              Una lista de reproducción dedicada para ti
            </h2>
          ...
          {currentTrackData ? (
            ...
            <div className="mb-6 h-20 flex items-center justify-center">
              <div className="text-base text-[#9a4c73] font-medium text-center">
                Elige una canción y empieza a disfrutar del ritmo
              </div>
            </div>
          )}
