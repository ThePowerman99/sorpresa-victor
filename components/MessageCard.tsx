                ...
                >
                  ...
                  <div className="text-center mt-6">
                    <p className="text-sm text-[#9a4c73] mb-2">
                      Haz click en el sobre para abrir la carta.
                    </p>
                      ...
                      <div className="bg-white rounded-xl p-6 sm:p-8 shadow-inner border border-pink-100 relative">
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="handwriting text-sm sm:text-base leading-relaxed text-[#1b0d14] pb-20 pt-6">
                            ...
                            <div
                              className="mb-6 text-justify overflow-y-auto max-h-[150px] scrollbar-thin scrollbar-thumb-pink-200 scrollbar-track-pink-50"
                              style={{ textIndent: '2rem' }}
                            >
                              En estos 6 meses hemos vivido tantas cosas..., me has enseñado lo que es amar y ser amado con todas sus mayúsculas, no podría desear una mejor compañía para esta vida y las demás que no seas tu cariño...
                              Gracias a ti he experimentado por primera vez una cantidad de cosas que no tiene ni sentido y con todo esto solo quería agradecerte infinitamente todo lo que haces por mi, aun que tenemos nuestros mas y nuestros menos algunas veces jeje. No he podido tener mas suerte en esta vida con la pedazo de pareja que me ha dejado tener la vida a mi lado, jamás me hubiera imaginado lograr tener a mi lado a alguien tan espectacular como TÚ mi vida, eres mágica, espectacular, preciosa, amable, cariñosa, cuidadosa, gentil.... eres literalmente con todas sus letras un ser de luz mi amor. 
                              Sigue mirando las demás cositas mi vida 😄
                            </div>
                            <div className="mt-8 ml-auto w-fit">
                              <div className="font-medium text-[#f04299]">
                                <TypewriterText
                                  text="Con todo mi amor, siempre tuyo 💕"
                                  duration={2}
                                  delay={0}
                                  onComplete={() =>
                        ...
                        typewriterComplete.stamped && (
                          <div className="flex justify-center mt-6 animate-slideUp">
                            <button
                              ...
                              aria-label="Haz click para continuar"
                            >
