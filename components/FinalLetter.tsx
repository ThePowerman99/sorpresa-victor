          ...
          >
            ...
            <article className="handwriting text-sm sm:text-base text-[#1b0d14] leading-relaxed space-y-4">
              <p className="text-[#f04299] font-semibold">
                Querida damisela mía,
              </p>
              <p>
                Sé que usted lleva mucho tiempo queriendo ir a un sitio que es muy bonito...
              </p>
              <p className="text-[#5a9bb8]">
                Es un detallito que llevo preparando en mi cabeza un tiempecito y que mejor dia para hacerlo que...
              </p>
              <p>
                NUESTROS 6 MESECITOOOS...
              </p>
              <p className="text-[#a67fb8]">
                Usted tiene una reserva para cenar conmigo el día 8 a las 20:00 románticamente con todo pagado, solo tiene que presentarse MUY BIEN VESTIDITA, que es nuestro día 😄
              </p>
            </article>

            <div className="mt-6 flex flex-col sm:flex-row justify-between gap-3 items-center">
              <div className="text-xs text-[#9a4c73]">
                El sellado completará la experiencia.
              </div>
              <div className="flex gap-3 relative">
                ...
                >
                  {isSealed ? 'Sellada 💌' : 'Sella esta carta 💌'}
                </button>
                {onRestart && (
                  <button
                    onClick={onRestart}
                    className="hidden rounded-full bg-[#9be7c4] px-4 py-2.5 text-sm sm:text-base font-medium shadow-md hover:brightness-95 transition cursor-pointer"
                  >
